...
I've also simplified the process for setting key images - you no longer need to resize the image before passing it into the key, as it's done automatically.
